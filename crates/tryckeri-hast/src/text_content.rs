...
pub fn text_content(arena: &MdastArena, node_id: u32) -> String {
    let mut out = String::new();
    collect(arena, node_id, &mut out);
    out
}

fn collect(arena: &MdastArena, node_id: u32, out: &mut String) {
...
mod tests {
    use super::*;
    use tryckeri_mdast::MdastBuilder;

    fn make_text_type_data(builder: &mut MdastBuilder, text: &str) -> Vec<u8> {
